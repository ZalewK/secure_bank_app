...
safe_password_message="Hasło jest niepoprawne."
safe_combination="^[A-Za-z0-9@$!%*?&]{5}$"
current_password_message="Obecne hasło jest napisane niepoprawnie."
...
confirm_password_message="Powtórzone hasło jest napisane niepoprawnie."
...
class TransferForm(FlaskForm):
    amount = IntegerField('Amount', validators=[DataRequired(message="Kwota przelewu musi być liczbą naturalną."), Length(max=8, message="Zbyt długa kwota."), NumberRange(min=1, max=1000000)])
